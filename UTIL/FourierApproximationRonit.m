function [fr_x,fr_y,rseqr] = FourierApproximationRonit(t,x_noisy,y_noisy,n)
%--------------------------------------------------------------------------
% Function by Ronit Fuchs, adapted for my usage
% 
% The function approximates the curve with fourier transform for every
% cordinate separately.
% Input:
%   t                 :   The time sempelse of the points of r_noisy
...
%Chake r_noisy. Make sure that evey row represents a dimention.
...
%----------------------------------------------------------------------
% Find the approximation to the path with first 8 coefficients of fourier
% transform for x and y apart.
%----------------------------------------------------------------------

switch n
    case 8
        % Approximate the X cordinate 
