...
for subjects= {'SM','LS','LB','RW','AS'}; %,'LB','LS' ,'AS' ,'RW','SM'
    ...
    for analog_i=1:length(analogs)
        ...
        for shape_i=1:length(shapes)
            ...
            SavingFile=['C:\Users\bnapp\Documents\tunnelledVisionPaper\analyzing\resultsVectors_forXY\' subjects{1,1} '\' nameOfFile];
            save(SavingFile,'numberOfRelevantTrials','labeled_saccade_vecs','XY_vecs_pix','XY_vecs_deg');
        end
    end
end
